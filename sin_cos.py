...
def sin_f(x, n):
    ...
    for i in range(0, n + 1):
        sum += pow(-1, i) * pow(x, 2 * i + 1) / factorial(2 * i + 1)  # Add each term of the series
...
def cos_f(x, n):
    sum = 0
    for i in range(0, n + 1):
        sum += pow(-1, i) * pow(x, 2 * i) / factorial(2 * i)  # Add each term of the series
    print(sum)  # Print the result
...
def sinh_f(x, n):
    sum = 0
    for i in range(0, n + 1):
        sum += pow(x, 2 * i + 1) / factorial(2 * i + 1)  # Add each term of the series
    print(sum)  # Print the result
...
def cosh_f(x, n):
    sum = 0
    for i in range(0, n + 1):
        sum += pow(x, 2 * i) / factorial(2 * i)  # Add each term of the series
    print(sum)  # Print the result
...
if isint(n) and isfloat(x):  # Check if the inputs are valid numbers
    ...
    func_name = input("Input function (sin / cos / sinh / cosh): ")  # Get the function name from user
